...
class SocialAuthNotificationService:
    ...
    @staticmethod
    async def notify_oauth_completed(
        user_id: str, platform: str, success: bool, account_data: Optional[Dict] = None
    ):
    ...
    @staticmethod
    async def notify_token_refreshed(
        user_id: str, platform: str, account_id: str, success: bool
    ):
    ...
    async def notify_rate_limit_hit(
        user_id: str, platform: str, reset_time: Optional[datetime] = None
    ):
    ...
    async def notify_webhook_received(
        user_id: str, platform: str, event_type: str, data: Dict
    ):
